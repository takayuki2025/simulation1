...
class Id07Test extends TestCase
{
    use RefreshDatabase;
        ...
        //* 商品詳細ページがすべての情報を正しく表示することをテストします。カテゴリーが複数選択されている商品も複数表示されるテストもしています。

    //ID07-1商品詳細ページにすべての情報を正しく表示することをテストします。
    //ID07-2商品詳細ページにカテゴリーが複数選択されている商品も複数表示されるテストもしています。
    public function test_item_detail_page_displays_all_information_correctly()
    {
        ...
        // 2人のユーザーがコメントを作成
        $commentUser1 = User::factory()->create(['name' => '加藤 結衣']);
        $commentUser2 = User::factory()->create(['name' => '原田 裕樹']);
